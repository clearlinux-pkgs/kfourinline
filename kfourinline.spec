...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/kfourinline-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/kfourinline-22.12.1.tar.xz.sig
...
%prep
%setup -q -n kfourinline-22.12.1
cd %{_builddir}/kfourinline-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673308126
mkdir -p clr-build
pushd clr-build
