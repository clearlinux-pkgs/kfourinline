...
Version  : 20.04.2
Release  : 22
URL      : https://download.kde.org/stable/release-service/20.04.2/src/kfourinline-20.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.04.2/src/kfourinline-20.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.2/src/kfourinline-20.04.2.tar.xz.sig
...
%prep
%setup -q -n kfourinline-20.04.2
cd %{_builddir}/kfourinline-20.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591903390
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kfourinline-20.04.2/COPYING %{buildroot}/usr/share/package-licenses/kfourinline/fafaf6b2753f82aa8df1d206d6b76c2241c2dfa8
cp %{_builddir}/kfourinline-20.04.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/kfourinline/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/kfourinline-20.04.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/kfourinline/ba8966e2473a9969bdcab3dc82274c817cfd98a1
pushd clr-build
%make_install
popd
