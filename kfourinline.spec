...
Version  : 23.08.3
Release  : 60
URL      : https://download.kde.org/stable/release-service/23.08.3/src/kfourinline-23.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/kfourinline-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/kfourinline-23.08.3.tar.xz.sig
...
%prep
%setup -q -n kfourinline-23.08.3
cd %{_builddir}/kfourinline-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699580346
mkdir -p clr-build
pushd clr-build
